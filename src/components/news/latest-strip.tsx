    ...
    <div className="flex gap-2.5 overflow-x-auto pb-1 -mx-1 px-1">
      {latest.map((item) => (
        <a
          ...
          className="shrink-0 w-56 rounded-xl border border-[var(--color-border-soft)] bg-[var(--color-bg-card)] p-3 hover:border-[var(--color-accent)]/35 hover:bg-[var(--color-accent)]/[0.04] transition-colors"
        >
