 ...
 *
 * Renders the identity as an accent-coloured, underline-free link. Clicking it
 * opens a small anchored popover offering "Open in Etherscan" / "Open in
 * Basescan" (both new-tab). Shared by every surface that surfaces on-chain
 * identities — bios, activity feed, chat bubbles, report narrative — so the
 * affordance and styling stay identical everywhere.
 */
