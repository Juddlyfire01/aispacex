    ...
    >
      ...
      {selectMode ? (
        ...
        >
          {item.starred ? (
            <span
              title="Remove bookmark to select for delete"
              className="inline-flex w-3.5 h-3.5 items-center justify-center text-[var(--color-accent)]"
              aria-label="Bookmarked — cannot bulk delete"
            >
              <svg
                width="10"
                height="10"
